...
// ************************************* Old functions not in use any more ************************************* //
  ...
  // router.post('/research-8/check-pay-and-submit/need-help-with-fees-ref', function(req, res) {
  //   var errors = []
  ...
  //       res.redirect('/research-8/check-pay-and-submit/help-with-fees-send-app')
  //     }
  //     else if (req.body['help-with-fees-ref'] === "no") {
  //       res.redirect('/research-8/check-pay-and-submit/get-hwf-reference')
  //     }
  //     else {
  ...
  //   }
  //   else {
  //       res.render('.//research-8/check-pay-and-submit/need-help-with-fees-ref', { errors: errors })
  //   }
  // })



  // router.post('/research-8/check-pay-and-submit/get-hwf-reference', function(req, res) {
  //   var errors = []
  //   if (req.body['ref'] === '') {
  //     errors.push({
  //     text: "Enter your reference number",
  ...
  //     }
  //     else {
  //       res.render('.//research-8/check-pay-and-submit/get-hwf-reference', { errors: errors })
  //     }
  //   }
  ...
  // router.post('/research-8/check-pay-and-submit/help-with-fees-send-app', function(req, res) {
  //   var errors = []
  //   if (req.body['ref'] === '') {
  //     errors.push({
  ...
  //     }
  //     else {
  //       res.render('.//research-8/check-pay-and-submit/help-with-fees-send-app', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/save-as-draft')
  ...
  // router.post('/research-8/check-pay-and-submit/process-payment', function(req, res) {
  //   res.redirect('/research-8/check-pay-and-submit/confirmation')
  // })


  // router.post('/research-8/children/solicitor-helping', function(req, res) {
  ...
  //         res.redirect('/research-8/children/solicitor-details')
  //       }
  //       else {
  //         req.session.data.agencyStatus = 'completed'
  //         res.redirect('/research-8/task-list')
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-helping', { errors: errors })
  //     }
  //   }
  //   else {
  //       res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-details', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-details', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/mother-why-no-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //         res.render('.//research-8/children/mother-why-no-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/father-why-no-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //         res.render('.//research-8/children/father-why-no-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/children/applicant-adoption-agency-details', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/child-adoption-agency-name')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-adoption-agency-details', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-name', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/applicant-social-worker-email')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/applicant-social-worker-team-email')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-team-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/applicant-social-worker-number')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-team-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-number', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/applicant-social-worker-address')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-number', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-address', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/applicant-social-worker-find-address')
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-find-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-find-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-social-worker-enter-address-manually', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-social-worker-enter-address-manually', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-adoption-agency-name', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/child-social-worker-name')
//     }
//     else {
//       res.render('.//research-8/children/child-adoption-agency-name', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-social-worker-name', function(req, res) {
//   var errors = []
//   if (req.body['child-social-worker-name'] === '') {
//     errors.push({
//     text: 'Enter the name of the social worker',
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/child-social-worker-email')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-name', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-social-worker-email', function(req, res) {
//   var errors = []
//   if (req.body['child-social-worker-email'] === '') {
//     errors.push({
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/child-social-worker-team-email')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-email', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
//TO FIX - MULTIPLE ERROR MESSAGE NEEDED
  ...
  // router.post('/research-8/children/child-social-worker-team-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/child-social-worker-number')
  //     }
  //     else {
  //       res.render('.//research-8/children/child-social-worker-team-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
...
//TO FIX - MULTIPLE ERROR MESSAGE NEEDED
// router.post('/research-8/children/child-social-worker-number', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/child-social-worker-address')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-number', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-social-worker-address', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/child-social-worker-find-address')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-address', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-social-worker-find-address', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/children/solicitor-helping')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-find-address', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// router.post('/research-8/children/child-social-worker-enter-address-manually', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-8/solicitor-helping')
//     }
//     else {
//       res.render('.//research-8/children/child-social-worker-enter-address-manually', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-8/task-list')
...
// })
  ...
  // router.post('/research-8/children/solicitor-firm-name', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/solicitor-name')
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-firm-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-name', function(req, res) {
  //   var errors = []
  //   if (req.body['solicitor-name'] === '') {
  //     errors.push({
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/solicitor-email')
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-email', function(req, res) {
  //   var errors = []
  //   if (req.body['solicitor-email'] === '') {
  //     errors.push({
  //     text: 'Enter an email address',
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/solicitor-number')
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-address', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/solicitor-find-address')
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-enter-address-manually', function(req, res) {
  //   var errors = []
  //   if (req.body['address-line-1'] === '') {
  //     errors.push({
  //     text: 'Enter the first line of the address',
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-enter-address-manually', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-find-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-find-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/solicitor-number', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-8/children/solicitor-address')
  //     }
  //     else {
  //       res.render('.//research-8/children/solicitor-number', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-8/task-list')
  ...
  // router.post('/research-8/children/applicant-adoption-agency-or-social-worker', function(req, res) {
  //   var errors = []
  ...
  //         res.redirect('/research-8/children/child-')
  //       }
  //       else {
  //         res.redirect('/research-8/children/child-social-worker-details')
  //       }
  //     }
  //     else {
  //       res.render('.//research-8/children/applicant-adoption-agency-or-social-worker', { errors: errors })
  //     }
  //   }
  //   else {
  //       res.redirect('/research-8/task-list')
...
//   router.post('/research-8/eligibility/10-weeks', function(req, res) {
//     var errors = []
...
//     if (errors.length === 0) {
//         res.redirect('/research-8/eligibility/under-18')
//     }
//     else {
//         res.render('.//research-8/eligibility/10-weeks', { errors: errors })
//     }
//   })

//   router.post('/research-8/applicants/number-of-children', function(req, res) {
//     var errors = []
...
//     if (req.body['submit-button'] === 'save-and-continue') {
//       if (errors.length === 0) {
//         res.redirect('/research-8/applicants/number-of-applicants')
//       }
//       else {
//         res.render('.//research-8/applicants/number-of-children', { errors: errors })
//       }
//     }
//     else {
//       res.redirect('/research-8/task-list')
...
//   router.post('/research-8/applicants/first-applicant-gender', function(req, res) {
//     var errors = []
...
//         }
//         else {
//             res.render('.//research-8/applicants/first-applicant-gender', { errors: errors })
//           }
//       }
//       else {
//         res.redirect('/research-8/task-list')
