...
// ********************** Eligibility **********************
  router.post('/research-2/eligibility/under-18', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['child-under-18'] === "Yes") {
        res.redirect('/research-2/eligibility/married')
      }
      else {
        res.redirect('/research-2/eligibility/cannot-apply-over-18')
      }
    }
    else {
        res.render('.//research-2/eligibility/under-18', { errors: errors })
    }

  })


  router.post('/research-2/eligibility/married', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['child-married'] === 'Yes') {
        res.redirect('/research-2/eligibility/cannot-apply-married')
      }
      else {
        res.redirect('/research-2/eligibility/under-21')
      }
    }
    else {
        res.render('.//research-2/eligibility/married', { errors: errors })
    }

  })


  router.post('/research-2/eligibility/under-21', function(req, res) {
    var errors = []
  ...
  router.post('/research-2/eligibility/lived-uk', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['lived-uk'] === "Yes") {
        res.redirect('/research-2/eligibility/do-you-need-help-with-fees')
      }
      else {
        res.redirect('/research-2/eligibility/cannot-apply-lived-uk')
      }
    }
    else {
        res.render('.//research-2/eligibility/lived-uk', { errors: errors })
    }
  })


  router.post('/research-2/eligibility/do-you-need-help-with-fees', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['need-help-with-fees'] === "Yes") {
        res.redirect('/research-2/eligibility/apply-for-help-with-fees')
      }
      else {
        res.redirect('/research-2/registration/start1')
      }
    }
    else {
        res.render('.//research-2/eligibility/do-you-need-help-with-fees', { errors: errors })
    }
  })
...
// ************************************************************************************************************************************
  ...
  router.post('/research-2/applicants/first-applicant-date-birth', function(req, res) {
    ...
    if (req.body['first-applicant-day'] === '' || req.body['first-applicant-month'] === '' || req.body['first-applicant-year'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/research-2/applicants/first-applicant-nationality')
        }
        else {
          res.render('.//research-2/applicants/first-applicant-date-birth', { errors: errors })
        }
      }
      else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/first-applicant-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/applicants/first-applicant-occupation')
      }
      else {
        res.render('.//research-2/applicants/first-applicant-nationality', { errors: errors })
      }
    }
  ...
  router.post('/research-2/applicants/first-applicant-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/task-list')
          ...
          res.render('.//research-2/applicants/first-applicant-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/first-applicant-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/applicants/first-applicant-find-address')
      }
      else {
        res.render('.//research-2/applicants/first-applicant-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/first-applicant-find-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/applicants/first-applicant-contact')
      }
      else {
        res.render('.//research-2/applicants/first-applicant-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/first-applicant-enter-address-manually', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/applicants/first-applicant-enter-address-manually', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/first-applicant-contact', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/applicants/first-applicant-contact', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/second-applicant-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/applicants/second-applicant-other-names')
      }
      else {
        res.render('.//research-2/applicants/second-applicant-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/second-applicant-other-names', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'add') {
      if (req.body['second-applicant-previous-first-names'] !== '' && req.body['second-applicant-previous-last-names'] !== '') {
        ...
        res.render('.//research-2/applicants/second-applicant-other-names', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/applicants/second-applicant-date-birth')
      }
      else {
        res.render('.//research-2/applicants/second-applicant-other-names', { errors: errors })
      }
  ...
  router.post('/research-2/applicants/second-applicant-date-birth', function(req, res) {
    ...
    if (req.body['second-applicant-day'] === '' || req.body['second-applicant-month'] === '' || req.body['second-applicant-year'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/research-2/applicants/second-applicant-nationality')
        }
        else {
          res.render('.//research-2/applicants/second-applicant-date-birth', { errors: errors })
        }
      }
      else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/second-applicant-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/applicants/second-applicant-occupation')
      }
      else {
        res.render('.//research-2/applicants/second-applicant-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/applicants/second-applicant-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/task-list')
          ...
          res.render('.//research-2/applicants/second-applicant-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
...
// ******************************************** Child's details ********************************************
  router.post('/research-2/children/child-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/child-date-birth')
      }
      else {
        res.render('.//research-2/children/child-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/child-date-birth', function(req, res) {
    // console.log("Day: ", req.body['day'])
    var errors = []
    if (req.body['child-birth-day'] === '' || req.body['child-birth-month'] === '' || req.body['child-birth-year'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/research-2/children/child-sex')
        }
        else {
          res.render('.//research-2/children/child-date-birth', { errors: errors })
        }
      }
      else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/child-sex', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/child-nationality')
      }
      else {
        res.render('.//research-2/children/child-sex', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/child-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/child-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/child-adoption-certificate', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/child-adoption-certificate', { errors: errors })
      }
    }
    else {
  ...
  router.post('/research-2/children/mother-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/mother-alive')
      }
      else {
        res.render('.//research-2/children/mother-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-alive', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['mother-alive'] === 'Yes') {
          res.redirect('/research-2/children/mother-nationality')
        }
        else {
        ...
        res.render('.//research-2/children/mother-alive', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/mother-occupation')
      }
      else {
        res.render('.//research-2/children/mother-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/mother-have-address')
      }
      else {
          res.render('.//research-2/children/mother-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['mother-have-address'] === 'No') {
          ...
          res.redirect('/research-2/children/mother-address-postcode')
        }
      }
      else {
          res.render('.//research-2/children/mother-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/mother-find-address')
      }
      else {
        res.render('.//research-2/children/mother-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-find-address', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/mother-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/mother-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/mother-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/mother-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-in-certificate', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-in-certificate'] == 'No') {
          ...
          res.redirect('/research-2/children/other-parent-exists')
        }
        else {
          res.redirect('/research-2/children/father-name')
        }
      }
      else {
          res.render('.//research-2/children/father-in-certificate', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/father-alive')
      }
      else {
        res.render('.//research-2/children/father-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-alive', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-alive'] === 'Yes') {
          res.redirect('/research-2/children/father-nationality')
        }
        else {
          req.session.data.fatherStatus = 'completed'
          res.redirect('/research-2/task-list')
        ...
        res.render('.//research-2/children/father-alive', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/father-occupation')
      }
      else {
        res.render('.//research-2/children/father-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/father-have-address')
      }
      else {
          res.render('.//research-2/children/father-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-have-address'] == 'No') {
          ...
          res.redirect('/research-2/children/father-address-postcode')
        }
      }
      else {
          res.render('.//research-2/children/father-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/father-find-address')
      }
      else {
        res.render('.//research-2/children/father-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-find-address', function(req, res) {
    // console.log(req.body['submit-button'])
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/father-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/father-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/father-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['father-address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/father-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-exists', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-parent-exists'] === 'Yes') {
          res.redirect('/research-2/children/other-parent-name')
        }
        else {
        ...
        res.render('.//research-2/children/other-parent-exists', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/other-parent-have-address')
      }
      else {
        res.render('.//research-2/children/other-parent-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-parent-have-address'] == 'No') {
          ...
          res.redirect('/research-2/children/other-parent-address-postcode')
        }
      }
      else {
          res.render('.//research-2/children/other-parent-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/children/other-parent-find-address')
      }
      else {
        res.render('.//research-2/children/other-parent-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-find-address', function(req, res) {
    // console.log(req.body['submit-button'])
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/other-parent-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/other-parent-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/other-parent-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['other-parent-address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/other-parent-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
 ...
 // ********************** Solicitor details **********************
  ...
  router.post('/research-2/children/orders-placement-case-number', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      ...
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/orders-placement-court')
      }
      else {
        res.render('.//research-2/children/orders-placement-case-number', { errors: errors })
      }
    }
    else {
      if (req.body['placement-case-number'] === '') {
  ...
  router.post('/research-2/children/orders-placement-court', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        req.session.data.childOrderCompleted[count] = "No"
        res.redirect('/research-2/children/orders-placement-date')
      }
      else {
        res.render('.//research-2/children/orders-placement-court', { errors: errors })
      }
    }
    else {
      if (req.body['placement-court-name'] === '') {
  ...
  router.post('/research-2/children/orders-placement-date', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/orders-summary')
      }
      else {
        res.render('.//research-2/children/orders-placement-date', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-summary', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'continue') {
      ...
      if (errors.length === 0) {
        if (req.body['add-another'] === 'Yes') {
          res.redirect('/research-2/children/orders-order-type')
        }
        else {
        ...
        res.render('.//research-2/children/orders-summary', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-order-type', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        req.session.data.childOrderCompleted[count] = "No"
        res.redirect('/research-2/children/orders-order-case-number')
      }
      else {
        res.render('.//research-2/children/orders-order-type', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-order-case-number', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/orders-order-court')
      }
      else {
        res.render('.//research-2/children/orders-order-case-number', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-order-court', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/orders-order-date')
      }
      else {
        res.render('.//research-2/children/orders-order-court', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-order-date', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/orders-order-date', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/orders-remove-court-order', function(req, res) {
    var occ = 0
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.render('.//research-2/children/orders-remove-order-court', { errors: errors })
    }
  })
  ...
  // ********************** Sibling details **********************
  router.post('/research-2/children/sibling-exists', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['sibling-exists'] === 'yes') {
          ...
          res.redirect('/research-2/children/sibling-court-order-exists')
        }
        else {
        ...
        res.render('.//research-2/children/sibling-exists', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-court-order-exists', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['sibling-court-order-exists'] === 'yes') {
          res.redirect('/research-2/children/sibling-name')
        }
        else {
          req.session.data.siblingStatus = 'completed'
          res.redirect('/research-2/task-list')
        ...
        res.render('.//research-2/children/sibling-court-order-exists', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/sibling-order-type')
      }
      else {
        res.render('.//research-2/children/sibling-name', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-change-name', function(req, res) {
    var errors = []
    if (req.body['sibling-first-names'] === '') {
      errors.push({
      text: 'Enter their first names',
    ...
    if (errors.length === 0) {
      ...
      res.redirect('/research-2/children/sibling-summary')
    }
    else {
      res.render('.//research-2/children/sibling-change-name', { errors: errors })
    }
  })


  router.post('/research-2/children/sibling-order-type', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/sibling-order-case-number')
      }
      else {
        res.render('.//research-2/children/sibling-order-type', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-change-order-type', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.redirect('/research-2/children/sibling-check-your-answers')
    }
    else {
      res.render('.//research-2/children/sibling-change-order-type', { errors: errors })
    }
  })



  router.post('/research-2/children/sibling-order-case-number', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/sibling-order-court')
      }
      else {
        res.render('.//research-2/children/sibling-order-case-number', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-change-order-case-number', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.render('.//research-2/children/sibling-change-case-number', { errors: errors })
    }
  })


  router.post('/research-2/children/sibling-order-court', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/research-2/children/sibling-order-date')
      }
      else {
        res.render('.//research-2/children/sibling-order-court', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-change-order-court', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.render('.//research-2/children/sibling-change-court', { errors: errors })
    }
  })


  router.post('/research-2/children/sibling-order-date', function(req, res) {
    var errors = []
...
//        req.session.data.siblingOrderCount = req.session.data.siblingOrderCount + 1
        ...
        res.render('.//research-2/children/sibling-order-date', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-change-order-date', function(req, res) {
    var errors = []
    if (req.body['sibling-day'] === '' || req.body['sibling-month'] === '' || req.body['sibling-year'] === '') {
      errors.push({
      text: 'Developers: please refer to ADOP-281 for different error messages',
    ...
    if (errors.length === 0) {
      ...
      res.render('.//research-2/children/sibling-change-order-date', { errors: errors })
    }
  })


  router.post('/research-2/children/sibling-summary', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'continue') {
      ...
      if (errors.length === 0) {
        if (req.body['sibling-add-another'] === 'Yes') {
          res.redirect('/research-2/children/sibling-choose-sibling')
        }
        else {
        ...
        res.render('.//research-2/children/sibling-summary', { errors: errors })
      }
    }
    else {
        res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-choose-sibling', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/children/sibling-choose-sibling', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/children/sibling-remove-court-order', function(req, res) {
    var occ = 0
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.render('.//research-2/children/sibling-remove-order-court', { errors: errors })
    }
  })
...
// ************************************************************************************************************************************
  ...
  // ********************** Uploads  **********************
  router.post('/research-2/upload/applicants-documents-upload', function(req, res) {
    // var errors = []
    // if (req.body['sibling-new-court-name'] === '') {
    //   errors.push({
    //   text: 'Please answer the question',
...
//    if (errors.length === 0) {
  ...
  router.post('/research-2/upload/child-documents-upload', function(req, res) {
    // var errors = []
    // if (req.body['sibling-new-court-name'] === '') {
    //   errors.push({
    //   text: 'Please answer the question',
...
//**************************************** Check, Pay and Submit ************************************************************
  ...
  router.post('/research-2/check-pay-and-submit/check-your-answers', function(req, res) {
    res.redirect('/research-2/check-pay-and-submit/declaration')
  })




//    router.post('/research-2/check-pay-and-submit/payment', function(req, res) {
  //    res.redirect('/research-2/check-pay-and-submit/confirmation')
  //      })

  router.post('/research-2/check-pay-and-submit/declaration', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/research-2/check-pay-and-submit/need-help-with-fees-ref')
      }
      else {
        res.render('.//research-2/check-pay-and-submit/declaration', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/check-pay-and-submit/need-help-with-fees-ref', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['help-with-fees-ref'] === "yes") {
        res.redirect('/research-2/check-pay-and-submit/help-with-fees-send-app')
      }
      else if (req.body['help-with-fees-ref'] === "no") {
        res.redirect('/research-2/check-pay-and-submit/get-hwf-reference')
      }
      else {
        ...
        res.render('.//research-2/check-pay-and-submit/need-help-with-fees-ref', { errors: errors })
    }
  })
  ...
  router.post('/research-2/check-pay-and-submit/get-hwf-reference', function(req, res) {
    var errors = []
    if (req.body['ref'] === '') {
      errors.push({
      text: "Enter your reference number",
    ...
    if (req.body['continue'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/check-pay-and-submit/get-hwf-reference', { errors: errors })
      }
    }
  ...
  router.post('/research-2/check-pay-and-submit/help-with-fees-send-app', function(req, res) {
    var errors = []
    if (req.body['ref'] === '') {
      errors.push({
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//research-2/check-pay-and-submit/help-with-fees-send-app', { errors: errors })
      }
    }
    else {
      res.redirect('/research-2/task-list')
  ...
  router.post('/research-2/check-pay-and-submit/process-payment', function(req, res) {
    res.redirect('/research-2/check-pay-and-submit/confirmation')
  })
// ***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************
// ************************************* Old functions not in use any more ************************************* //
  ...
  //     }
  //     else {
  //         res.render('.//research-2/children/mother-why-no-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/father-why-no-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //         res.render('.//research-2/children/father-why-no-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/children/applicant-adoption-agency-details', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/child-adoption-agency-name')
  //     }
  //     else {
  ...
  // router.post('/research-2/children/applicant-social-worker-name', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/applicant-social-worker-email')
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/applicant-social-worker-team-email')
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-team-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/applicant-social-worker-number')
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-team-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-number', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/applicant-social-worker-address')
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-number', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-address', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/applicant-social-worker-find-address')
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-find-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-find-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-social-worker-enter-address-manually', function(req, res) {
  //   var errors = []
  //   if (req.body['address-line-1'] === '') {
  //     errors.push({
  //     text: 'Enter the first line of the address',
  ...
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-social-worker-enter-address-manually', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-adoption-agency-name', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/children/child-social-worker-name')
//     }
//     else {
//       res.render('.//research-2/children/child-adoption-agency-name', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-social-worker-name', function(req, res) {
//   var errors = []
//   if (req.body['child-social-worker-name'] === '') {
//     errors.push({
//     text: 'Enter the name of the social worker',
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/children/child-social-worker-email')
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-name', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-social-worker-email', function(req, res) {
//   var errors = []
//   if (req.body['child-social-worker-email'] === '') {
//     errors.push({
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/children/child-social-worker-team-email')
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-email', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
//TO FIX - MULTIPLE ERROR MESSAGE NEEDED
  ...
  // router.post('/research-2/children/child-social-worker-team-email', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/child-social-worker-number')
  //     }
  //     else {
  //       res.render('.//research-2/children/child-social-worker-team-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
...
//TO FIX - MULTIPLE ERROR MESSAGE NEEDED
// router.post('/research-2/children/child-social-worker-number', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/children/child-social-worker-address')
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-number', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-social-worker-address', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/children/child-social-worker-find-address')
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-address', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-social-worker-find-address', function(req, res) {
//   var errors = []
...
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-find-address', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// router.post('/research-2/children/child-social-worker-enter-address-manually', function(req, res) {
//   var errors = []
...
//   if (req.body['submit-button'] === 'save-and-continue') {
//     if (errors.length === 0) {
//       res.redirect('/research-2/solicitor-helping')
//     }
//     else {
//       res.render('.//research-2/children/child-social-worker-enter-address-manually', { errors: errors })
//     }
//   }
//   else {
//     res.redirect('/research-2/task-list')
...
// })
  ...
  // router.post('/research-2/children/solicitor-firm-name', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/solicitor-name')
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-firm-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-name', function(req, res) {
  //   var errors = []
  //   if (req.body['solicitor-name'] === '') {
  //     errors.push({
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/solicitor-email')
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-name', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-email', function(req, res) {
  //   var errors = []
  //   if (req.body['solicitor-email'] === '') {
  //     errors.push({
  //     text: 'Enter an email address',
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/solicitor-number')
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-email', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-address', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/solicitor-find-address')
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-enter-address-manually', function(req, res) {
  //   var errors = []
  //   if (req.body['address-line-1'] === '') {
  //     errors.push({
  //     text: 'Enter the first line of the address',
  ...
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-enter-address-manually', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-find-address', function(req, res) {
  //   var errors = []
  ...
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-find-address', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/solicitor-number', function(req, res) {
  //   var errors = []
  ...
  //   if (req.body['submit-button'] === 'save-and-continue') {
  //     if (errors.length === 0) {
  //       res.redirect('/research-2/children/solicitor-address')
  //     }
  //     else {
  //       res.render('.//research-2/children/solicitor-number', { errors: errors })
  //     }
  //   }
  //   else {
  //     res.redirect('/research-2/task-list')
  ...
  // router.post('/research-2/children/applicant-adoption-agency-or-social-worker', function(req, res) {
  //   var errors = []
  ...
  //         res.redirect('/research-2/children/child-')
  //       }
  //       else {
  ...
  //     }
  //     else {
  //       res.render('.//research-2/children/applicant-adoption-agency-or-social-worker', { errors: errors })
  //     }
  //   }
  //   else {
  //       res.redirect('/research-2/task-list')
...
//   router.post('/research-2/eligibility/10-weeks', function(req, res) {
//     var errors = []
...
//     if (errors.length === 0) {
//         res.redirect('/research-2/eligibility/under-18')
//     }
//     else {
//         res.render('.//research-2/eligibility/10-weeks', { errors: errors })
//     }
//   })

//   router.post('/research-2/applicants/number-of-children', function(req, res) {
//     var errors = []
...
//     if (req.body['submit-button'] === 'save-and-continue') {
//       if (errors.length === 0) {
//         res.redirect('/research-2/applicants/number-of-applicants')
//       }
//       else {
//         res.render('.//research-2/applicants/number-of-children', { errors: errors })
//       }
//     }
//     else {
//       res.redirect('/research-2/task-list')
...
//   router.post('/research-2/applicants/first-applicant-gender', function(req, res) {
//     var errors = []
...
//         }
//         else {
//             res.render('.//research-2/applicants/first-applicant-gender', { errors: errors })
//           }
//       }
//       else {
//         res.redirect('/research-2/task-list')
