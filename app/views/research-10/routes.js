...
// ************************************************************************************************************************************
  ...
  router.post('/research-10/includes/next-steps-case-worker', function(req, res) {
    if (req.body['next-steps'] === 'notes') {
      res.redirect('/research-10/case-worker/x')
    }
    else {
  ...
  router.post('/research-10/case-worker/case-worker-manage-documents', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      if (req.body['document-type'] === 'Statements') {
        res.redirect('/research-10/case-worker/case-worker-statements-select-respondent')
      }
      else {
        res.redirect('/research-10/case-worker/case-worker-upload')
      }
    }
    else {
  ...
  router.post('/research-10/case-worker/case-worker-statements-select-respondent', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-intention-oppose', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-upload', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      if (req.body['document-type'] === "Correspondence") {
  ...
  router.post('/research-10/case-worker/case-worker-edit-document', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-statements-select-respondent')
    }
    else if (req.body['add-new-button'] === 'add-new-button-top' || req.body['add-new-button'] === 'add-new-button-bottom' || req.body['remove-button'] === 'remove') {
      res.redirect('/research-10/case-worker/case-worker-edit-document')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-documents')
    }
  ...
  router.post('/research-10/case-worker/case-worker-message-radios', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-messages-select-person')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-messages')
    }
  })


  router.post('/research-10/case-worker/case-worker-messages-select-person', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-send-message')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-message-radios')
    }
  })


  router.post('/research-10/case-worker/case-worker-messages-send-message', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-message-send-and-reply', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      if (req.body['xui-send-reply-radio'] === 'send') {
        res.redirect('/research-10/case-worker/case-worker-send-message')
      }
      else {
        res.redirect('/research-10/case-worker/case-worker-message-reply-required')
      }
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-messages')
  ...
  router.post('/research-10/case-worker/case-worker-messages-reply-message', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      req.session.data.repliedMessage = 1
      res.redirect('/research-10/case-worker/case-worker-messages')
    }
  ...
  router.post('/research-10/case-worker/case-worker-message-check-your-answers', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      req.session.data.repliedMessage = 1
      res.redirect('/research-10/case-worker/case-worker-messages')
    }
  ...
  router.post('/research-10/case-worker/case-worker-add-note', function(req, res) {
    console.log("Note")
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-notes-check-your-answers')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-notes')
    }
  })


  router.post('/research-10/case-worker/case-worker-notes-check-your-answers', function(req, res) {
    console.log("Note")
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/index')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-add-note')
    }
  })


  router.post('/research-10/case-worker/case-worker-add-note-summary', function(req, res) {
    console.log("Note")
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/index')
    }
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-directions', function(req, res) {
    console.log("Note")
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-order-creation-manage-orders', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-order-creation-type-of-order', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-order-creation-case-management-order', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-annexa-required-by')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-order-creation-type-of-order')
    }
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-annexa-required-by', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-birth-parents-details-required-by')
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-order-creation-case-management-order')
    }
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-birth-parents-details-required-by', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-order-creation-judge')  
    }
    else {
      res.redirect('/research-10/case-worker/case-worker-gatekeeping-annexa-required-by')
    }
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-order-creation-judge', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/case-worker/index')
    }
    else {
  ...
  router.post('/research-10/case-worker/case-worker-gatekeeping-allocate-judge', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
  ...
  router.post('/research-10/case-worker/index', function(req, res) {
    ...
    if (req.body['next-steps'] === 'manage-documents') {
      ...
      req.session.data.newNote = 'yes'
      res.redirect('/research-10/case-worker/case-worker-seek-further-information')
    }
  })

  router.post('/research-10/case-worker/case-worker-seek-further-information', function(req, res) {
    if (req.body['submit-button'] === 'continue') {

      res.redirect('/research-10/case-worker/case-worker-seek-further-information-send-message')
    }
    // }
  ...
  router.post('/research-10/case-worker/case-worker-seek-further-information-send-message', function(req, res) {
    if (req.body['submit-button'] === 'continue') {

      res.redirect('/research-10/case-worker/case-worker-seek-further-information-reply-by')
    }
    // }
    else if (req.body['submit-button'] === 'previous') {
      res.redirect('/research-10/case-worker/case-worker-seek-further-information')
...
// ************************************************************************************************************************************
  ...
  router.post('/research-10/includes/next-steps-judge', function(req, res) {
    if (req.body['next-steps'] === 'notes') {
      ...
      res.redirect('/research-10/judge/')
    }
  })


  router.post('/research-10/judge/judge-manage-documents', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      if (req.body['document-type'] === 'Statements') {
        res.redirect('/research-10/judge/judge-statements-select-respondent')
      }
      else {
        res.redirect('/research-10/judge/judge-upload')
      }
    }
    else {
      res.redirect('/research-10/judge/judge-documents')
    }
  })


  router.post('/research-10/judge/judge-statements-select-respondent', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      // if (req.body['respondent-role'] === 'birth mother' || req.body['respondent-role'] === 'birth father' || req.body['respondent-role'] === 'person with parental responsibility') {
      //   res.redirect('/research-10/judge/judge-intention-oppose')
      // }
      // else {
      res.redirect('/research-10/judge/judge-upload')
    }
    // }
      ...
      res.redirect('/research-10/judge/judge-manage-documents')
    }
  })


  router.post('/research-10/judge/judge-intention-oppose', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      if (req.body['intend-oppose'] === 'no') {
        req.session.data.intentionOppose = 'no'
      }
  ...
  router.post('/research-10/judge/judge-upload', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/judge/judge-documents')
    }
    else if (req.body['add-new-button'] === 'add-new-button-top' || req.body['add-new-button'] === 'add-new-button-bottom' || req.body['remove-button'] === 'remove') {
  ...
  router.post('/research-10/judge/judge-message-radios', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/judge/judge-messages-select-person')
    }
    else {
      res.redirect('/research-10/judge/judge-messages')
    }
  })


  router.post('/research-10/judge/judge-messages-select-person', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/judge/judge-send-message')
    }
    else {
      res.redirect('/research-10/judge/judge-message-radios')
    }
  })


  router.post('/research-10/judge/judge-send-message', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/judge/judge-message-sent')
    }
    else {
      res.redirect('/research-10/judge/judge-messages-select-person')
    }
  ...
  router.post('/research-10/judge/judge-message-sent', function(req, res) {
    if (req.body['submit-button'] === 'continue') {
      res.redirect('/research-10/judge/judge-messages')
    }
    else {
  ...
  router.post('/research-10/judge/index', function(req, res) {
    console.log(req.body['next-steps'])
    if (req.body['next-steps'] === 'manage-documents') {
      res.redirect('/research-10/judge/judge-manage-documents')
    }
      ...
      req.session.data.newNote = 'yes'
      res.redirect('/research-10/judge/judge-add-note')
    }
    else if (req.body['next-steps'] === 'send-a-message') {
      res.redirect('/research-10/judge/judge-message-radios')
    }
